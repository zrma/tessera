...
Kubernetes 범위는 이 runtime이 횡적 확장 가능한 컨테이너 아키텍처를 따르도록 portable chart/template와 검증 경계를 제공하는 데 있으며, 특정 live service의 운영 정책을 소유하는 데 있지 않다.
...
- Active packaged log-format parity: `docs/todo-p18-packaged-log-format.md`.
