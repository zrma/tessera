...
| Local/dev and internal smoke command catalog | `smoke-runbook.md` |
| Packaging examples and non-GitOps deployment samples | `packaging.md` |
...
| P10 runtime observability and soak hardening | Active; local observability soak added, remaining gates fail closed | `p10-runtime-observability-soak-hardening.md` |
...
| Internal MicroK8s activation smoke evidence | `internal-microk8s-activation-smoke.md` |
| P6 internal rollout command/runbook record | `p6-internal-rollout-runbook.md` |
| Historical P4 decision gates | `todo-p4-next-milestones.md` |
