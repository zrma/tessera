...
- P7 local operation coverage includes default-off split/merge/canonical
  ...
  execution success/idempotency via
  `cargo xt dev p7-operation-split-execution-smoke`. Split
  observation/recovery/restart/soak and canonical multi-depth operation
  execution remain P7+ expansion gates.
