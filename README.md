...
- GitHub Actions image publish workflow는 build/push only로 `v2026.05.3` Harbor image까지 발행했고, k8s GitOps repo에서 해당 tag로 controlled smoke promotion되어 ArgoCD sync와 internal split/merge/multi-depth activation success/failure/restart/soak smoke까지 통과했다.
