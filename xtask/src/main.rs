...
fn p7_completion_findings(report_dir: &Path) -> Vec<P7CompletionFinding> {
    ...
    push_p7_json_gate(
        ...
        "guarded-kubernetes-p7-operation-smoke-latest.json",
        "guarded Kubernetes approved execution, completed observation, and parent-route soak report",
        |report| {
            validate_internal_k8s_operation_report(
                report,
                InternalP7OperationRequirements {
    ...
    push_p7_json_gate(
        ...
        "guarded-kubernetes-p7-operation-failure-smoke-latest.json",
        "guarded Kubernetes owner Worker failure, recovery-required ledger, and operator recovery report",
        |report| {
            validate_internal_k8s_operation_report(
                report,
                InternalP7OperationRequirements {
    ...
    push_p7_json_gate(
        ...
        "guarded-kubernetes-p7-operation-restart-smoke-latest.json",
        "guarded Kubernetes PVC-backed Orchestrator restart recovery and completed observation report",
        |report| {
            validate_internal_k8s_operation_report(
                report,
                InternalP7OperationRequirements {
